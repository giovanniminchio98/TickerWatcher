...
def _build_prompt(snapshot):
    ...
    return (
        ...
        "just a space). Part 1: your genuine in-voice reaction leading straight into the actual news "
        ...
        "voice. Never merge the two into one continuous paragraph. Use genuinely "
