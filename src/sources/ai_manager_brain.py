...
def _build_prompt(snapshot):
    ...
    return (
        ...
        "- digest.intro: a short standalone lead-in line to the thread below (e.g. 'A few more "
        "things worth knowing about today:') -- do not add your own thread emoji or 'see replies' "
        "marker, code appends one automatically.\n"
